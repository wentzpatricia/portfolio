import Detail from '../../../src/assets/detail-home.svg?react';
...
const Home = () => (
  <section id="home" className="pt-20 flex flex-wrap justify-center">
    ...
    <button type="button" className="mt-4 px-6 py-2 bg-medium-red-violet-800 text-medium-red-violet-50 font-medium rounded-lg cursor-pointer">Baixar resumo</button>
    </div>
    <figure className="w-full md:w-2/5 p-4 flex justify-center items-center relative">
      <Detail className="absolute animate-rotate-diagonal" />
      <Detail className="absolute animate-rotate-diagona" />
    </figure>
